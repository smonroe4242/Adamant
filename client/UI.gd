...
func _character_sheet(p):
	...
	list.add_item("Health   | " + str(p.attributes.hp))
	list.add_item("Mana     | " + str(p.attributes.mana))
	list.add_item("Strength | " + str(p.attributes.strength))
	list.add_item("Stamina  | " + str(p.attributes.stamina))
	list.add_item("Intellect| " + str(p.attributes.intellect))
	list.add_item("Wisdom   | " + str(p.attributes.wisdom))
	list.add_item("Dexterity| " + str(p.attributes.dexterity))
	list.add_item("Luck     | " + str(p.attributes.luck))
